                        ...
                        <?php if ($materials): ?>
                            <?php foreach ($materials as $material): ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit-material.php?id=<?= $material['MaterialID']; ?>" class="btn btn-warning btn-sm mt-1"><i class="fa fa-edit"></i></a>
                                        <a href="?action=delete&id=<?= $material['MaterialID']; ?>" class="btn btn-danger btn-sm mt-1" onclick="return confirm('Are you sure?');"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
                        <?php else: ?>
