...
<body data-bs-spy="scroll" data-bs-target="#navbarNav" data-bs-offset="0" tabindex="0"  >
    ...
    <!-- Header with Navbar -->
    <header class="sticky-top text-dark p-3">
        <div class="container ">
            <nav  class="navbar nav-pills navbar-expand-md ">
                <div class="container-fluid d-flex justify-content-between align-items-center">
                    <!-- Logo on the left -->
                    <a class="nav-link mb-2" href="<?=BASE_URL; ?>">
                    ...
                    <div class="collapse nav-pills navbar-collapse" id="navbarNav">
                        ...
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                ...
                                <a href="<?=BASE_URL; ?>pages/logout.php" class="btn btn-sm btn-danger mt-1"
                                    role="button"><i class="fa fa-sign-out"></i>
                                </a>
                                <?php else: ?>
                                <a href="<?=BASE_URL; ?>pages/login.php" role="button"
                                    class="btn btn-sm btn-success login mt-1">
                                    <i class="fa fa-key"></i>
                                </a>
                                <?php endif; ?>
                            </li>
